        ...
        <Navbar className="mx-auto w-full px-4 py-2 lg:px-8 lg:py-4 bg-black border-none opacity-[0.98] fixed top-0 z-50" fullWidth={true}>
            <div className="mx-auto flex items-center justify-between text-white">
                <Typography
                    as="a"
                    href="#"
                    className="mr-4 cursor-pointer py-1.5 font-semibold text-4xl tracking-widest italic text-[#ffda36]"
                >
                ...
                <div className="flex items-center gap-x-1">
                    {/* <Button
                        ...
                        size="sm"
                        className="hidden lg:inline-block bg-[#caa430] hover:bg-opacity-70"
                    >
            ...
            <Collapse open={openNav}>
                <div className="container mx-auto z-50">
                    {navList}
                    {/* <div className="flex items-center gap-x-1">
                        <Button fullWidth  size="sm" className="bg-[#caa430]">
