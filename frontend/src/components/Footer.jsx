...
export function Footer() {
    return (
        <footer className="relative w-full mt-10 bg-gray-900 pt-20 text-gray-300">
                ...
                <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
                    ...
                    <div className="grid grid-cols-3 justify-between gap-4">
                        ...
                        <div>
                            ...
                            <img src="https://carvinscheck.com/wp-content/themes/carvinscheck/assets/img/payment-method.webp" alt="" />
                        </div>
                    </div>
                </div>
