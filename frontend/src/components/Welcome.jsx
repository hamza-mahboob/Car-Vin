...
const Welcome = () => {
    return (
        <div className='pt-20 min-h-screen flex flex-col mx-auto px-2'>
            <h1 className="text-3xl lg:text-5xl text-center font-semibold text-gray-900 my-5 md:my-10 uppercase tracking-tight">Welcome To <span className='text-[#8983ff]'>Car VINs Check</span></h1>
