    ...
    <>
      ...
      <div className="relative overflow-hidden h-screen">
        ...
        <div className="relative flex flex-col items-center justify-center h-full z-10 text-white">
          <h1 className="text-6xl text-center font-semibold mb-4 uppercase text-[#ffda36]">CarFax Check</h1>
      ...
      <div className='min-h-[45rem] pt-20 bg-gray-100'>
        ...
        <div className='flex flex-col md:flex-row items-center justify-center mx-auto gap-x-10 gap-y-5'>
          <div className='w-full md:w-1/3 text-center md:text-start'>
            <h2 className='text-xl text-[#cfb12c] font-normal my-2 px-2'>Why we stand out in the crowd!</h2>
      ...
      <div className='bg-gray-300 min-h-[45rem] py-20'>
        <h1 className='text-center text-5xl text-[#cfb12c] tracking-tight font-semibold'><span className='underline'>CARFAXCHECKS</span> VS CarFax & Others</h1>
        <h3 className='text-center text-md font-normal px-2 tracking-wide text-[#cfb12c] mt-12'>Do not overpay Choose Autoswift the service you can easily rely on</h3>
      ...
      <div className='min-h-[45rem] flex flex-col md:flex-row max-w-screen-xl mx-auto justify-center items-center mt-20'>
        ...
        <div className='w-full md:w-2/3 p-2 grid grid-cols-2 gap-10 text-gray-700 tracking-wider'>
          <div>
            <h1 className='mb-5 text-xl text-[#caa430] font-semibold'>01 Total Recall</h1>
            A recall is issued when a manufacturer or NHTSA determines that a vehicle, equipment, car seat, or tire creates an unreasonable safety risk or fails to meet minimum safety standards
          </div>
          <div>
            <h1 className='mb-5 text-xl text-[#caa430] font-semibold'>02 Market Value Range</h1>
          ...
          <div>
            <h1 className='mb-5 text-xl text-[#caa430] font-semibold'>03 Liens Status</h1>
          ...
          <div>
            <h1 className='mb-5 text-xl text-[#caa430] font-semibold'>04 Buy Now</h1>
            <Button className='w-full h-14 bg-[#caa430]'>Buy Now</Button>
          </div>
        </div>
      </div>
    </>
