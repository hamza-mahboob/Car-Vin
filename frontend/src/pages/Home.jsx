    ...
    <>
      ...
      <div className="relative overflow-hidden h-screen">
        ...
        <div className="relative flex flex-col items-center justify-center h-full z-10 px-3">
          <h1 className="text-5xl lg:text-6xl text-center font-semibold mb-4 uppercase text-[#990011]">CarFax Check</h1>
      ...
      <div className='min-h-[45rem] pt-20 bg-gray-100'>
        <h1 className='text-center text-3xl md:text-6xl text-[#990011] font-semibold tracking-normal mb-10'>
          WHY CHOOSE US
        </h1>
        <div className='flex flex-col md:flex-row items-center justify-center mx-auto gap-x-10 gap-y-5'>
          <div className='w-full md:w-1/3 text-center md:text-start'>
            <h2 className='text-xl text-[#990011] font-normal my-2 px-2'>Why we stand out in the crowd!</h2>
      ...
      <div className='bg-gray-300 min-h-[45rem] py-20 px-3 lg:px-2'>
        <h1 className='text-center text-3xl ld:text-5xl text-[#990011] tracking-tight font-semibold'><span className='underline'>CARFAXCHECKS</span> VS CarFax & Others</h1>
        <h3 className='text-center text-md font-normal px-2 tracking-wide text-[#990011] mt-12'>Do not overpay Choose Autoswift the service you can easily rely on</h3>
      ...
      <div className='min-h-[45rem] flex flex-col md:flex-row max-w-screen-xl mx-auto justify-center items-center mt-20 p-2'>
        <h1 className='text-3xl lg:text-4xl text-[#990011] tracking-tighter w-full md:w-1/3 font-bold text-center md:text-start mb-10'>FOR YOUR INFO</h1>
        <div className='w-full md:w-2/3 p-2 grid grid-cols-2 gap-10 text-gray-700 tracking-wider'>
          <div>
            <h1 className='mb-5 text-xl text-[#990011] font-semibold'>01 Total Recall</h1>
            A recall is issued when a manufacturer or NHTSA determines that a vehicle, equipment, car seat, or tire creates an unreasonable safety risk or fails to meet minimum safety standards
          </div>
          <div>
            <h1 className='mb-5 text-xl text-[#990011] font-semibold'>02 Market Value Range</h1>
          ...
          <div>
            <h1 className='mb-5 text-xl text-[#990011] font-semibold'>03 Liens Status</h1>
          ...
          <div>
            <h1 className='mb-5 text-xl text-[#990011] font-semibold'>04 Buy Now</h1>
            <Button className='w-full h-14 bg-[#990011]' onClick={() => navigate('/pricing')}>Buy Now</Button>
          </div>
        </div>
      </div>
    </>
